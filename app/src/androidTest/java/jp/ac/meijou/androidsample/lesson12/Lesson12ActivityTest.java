...
/**
 * Lesson12Activity の UI テスト（Instrumented Test）。
 */
...
public class Lesson12ActivityTest {
    ...
    public void testDateButtonUpdatesCalendar() {
        ...
        // CalendarViewが表示されたままであることを確認（内部のDayPickerViewとの曖昧さを避けるため型を指定）
        onView(allOf(withId(R.id.calendarView), instanceOf(android.widget.CalendarView.class)))
